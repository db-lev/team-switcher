...
function MyersCapitalUseCase() {
  return (
    <>
      ...
      {/* The People */}
      <div>
        <h2 className="mb-4 text-lg font-semibold">The People</h2>
      ...
      <div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="rounded-lg border bg-card">
            ...
            <div className="p-4">
              <p className="text-sm leading-relaxed text-muted-foreground">
                Part of Enterprise pilot team. Primarily acts as a broker but requested to be added as a main lender contact for certain deals where Northmarq can provide direct financing.
              </p>
            </div>
          </div>
        </div>
