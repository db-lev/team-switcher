...
export default function UseCasesPage() {
  return (
    <div className="flex flex-1 flex-col gap-12 p-6">
      {/* Page Header */}
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-bold">All Use Cases</h1>
        <p className="text-muted-foreground">
          A comprehensive archive of all use case scenarios for the team switcher concept
        </p>
      </div>
      ...
      {/* Use Case 1: Myers Capital */}
      <div className="flex flex-col gap-6">
        <div className="flex items-center gap-2">
          <span className="font-mono text-xs font-semibold uppercase tracking-wider text-muted-foreground">Use Case 1</span>
        </div>
        <MyersCapitalUseCase />
      </div>
      ...
      {/* Use Case 2: Heritage Bank */}
      <div className="flex flex-col gap-6">
        <div className="flex items-center gap-2">
          <span className="font-mono text-xs font-semibold uppercase tracking-wider text-muted-foreground">Use Case 2</span>
        </div>
        <HeritageBankUseCase />
      </div>
      ...
      {/* Use Case 3: Leverage Companies */}
      <div className="flex flex-col gap-6">
        <div className="flex items-center gap-2">
          <span className="font-mono text-xs font-semibold uppercase tracking-wider text-muted-foreground">Use Case 3</span>
        </div>
        <LeverageCompaniesUseCase />
      </div>

      {/* Divider */}
      <div className="border-t" />

      {/* Use Case 4: Northmarq */}
      <div className="flex flex-col gap-6">
        <div className="flex items-center gap-2">
          <span className="font-mono text-xs font-semibold uppercase tracking-wider text-muted-foreground">Use Case 4</span>
        </div>
        <NorthmarqUseCase />
      </div>
      ...
      <div className="flex flex-col gap-6">
        <div className="flex items-center gap-2">
          <span className="font-mono text-xs font-semibold uppercase tracking-wider text-muted-foreground">Use Case 5</span>
        </div>
        <BWEUseCase />
      </div>
    </div>
      ...
      <div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="space-y-3 text-sm text-muted-foreground leading-relaxed">
            ...
            <p>
              This scenario demonstrates the need for flexible role assignment at the individual user level. Graham operates in both capacities within the same organization. When brokering, he needs outreach tools and placement tracking. When acting as a lender contact, he needs to see incoming placements and respond to deal submissions. The platform must support this dual-role workflow without requiring him to manually switch modes or maintain completely separate organizational boundaries.
            </p>
          </div>
        </div>
      </div>
